...
function szamolas() {
        ...
        if (document.getElementById(`kedv1`).checked) {
...
if ((uto == "1") || (uto == "4") || (uto == "5") || (uto == "7") || (uto == "9") || (vege == "10") || (vege == "12") || (vege == "22")) tag = "-én";
else tag = "-án";

document.getElementsByClassName("lastmod").addEventListener(ev, ". ", honap[last.getMonth()], " ", last.getDate(), tag);
